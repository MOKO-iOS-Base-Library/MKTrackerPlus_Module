...
static NSString *const MKTPTrackerDataCellIdenty = @"MKTPTrackerDataCellIdenty";

@interface MKTPTrackerDataCell ()
...
@implementation MKTPTrackerDataCell

+ (MKTPTrackerDataCell *)initCellWithTableView:(UITableView *)tableView {
    MKTPTrackerDataCell *cell = [tableView dequeueReusableCellWithIdentifier:MKTPTrackerDataCellIdenty];
    if (!cell) {
        cell = [[MKTPTrackerDataCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:MKTPTrackerDataCellIdenty];
    }
    return cell;
}
