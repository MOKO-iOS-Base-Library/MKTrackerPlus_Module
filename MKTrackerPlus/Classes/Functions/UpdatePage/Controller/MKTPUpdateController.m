...
@interface MKTPUpdateController ()<UITableViewDelegate,UITableViewDataSource>

@property (nonatomic, strong)MKBaseTableView *tableView;

@property (nonatomic, strong)NSMutableArray *dataList;

@property (nonatomic, strong)MKTPDFUModule *dfuModule;
...
@implementation MKTPUpdateController

- (void)dealloc {
    NSLog(@"MKTPUpdateController销毁");
...
- (void)updateComplete {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"mk_tp_centralDeallocNotification" object:nil];
...
- (MKTPDFUModule *)dfuModule {
    if (!_dfuModule) {
        _dfuModule = [[MKTPDFUModule alloc] init];
    }
    return _dfuModule;
}
