...
@interface MKTPLowPowerNoteSlider : UISlider
@end

@implementation MKTPLowPowerNoteSlider

- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        [self setThumbImage:[LOADICON(@"MKTrackerPlus", @"MKTPTriggerSenSlider", @"tp_sensitivityThumbIcon.png") resizableImageWithCapInsets:UIEdgeInsetsZero]
                   forState:UIControlStateNormal];
        [self setThumbImage:[LOADICON(@"MKTrackerPlus", @"MKTPTriggerSenSlider", @"tp_sensitivityThumbIcon.png") resizableImageWithCapInsets:UIEdgeInsetsZero]
                   forState:UIControlStateHighlighted];
        [self setMinimumTrackImage:[LOADICON(@"MKTrackerPlus", @"MKTPTriggerSenSlider", @"tp_sensitivityMaxTrackIcon.png") resizableImageWithCapInsets:UIEdgeInsetsZero]
                          forState:UIControlStateNormal];
        [self setMaximumTrackImage:[LOADICON(@"MKTrackerPlus", @"MKTPTriggerSenSlider", @"tp_sensitivityMinTrackIcon.png") resizableImageWithCapInsets:UIEdgeInsetsZero] forState:UIControlStateNormal];
    }
    return self;
}
...
@interface MKTPLowPowerNoteConfigView ()
...
@implementation MKTPLowPowerNoteConfigView

- (void)dealloc {
    NSLog(@"MKTPLowPowerNoteConfigView销毁");
}
...
- (void)sliderValueChanged:(MKTPLowPowerNoteSlider *)slider {
...
+ (void)showViewWithTwentyValue:(NSInteger)twentyValue
    ...
    MKTPLowPowerNoteConfigView *view = [[MKTPLowPowerNoteConfigView alloc] init];
    [view showViewWithValue:twentyValue
                   tenValue:tenValue
                  fiveValue:fiveValue
              completeBlock:block];
}
...
- (MKTPLowPowerNoteSlider *)batterySlider1 {
    if (!_batterySlider1) {
        _batterySlider1 = [[MKTPLowPowerNoteSlider alloc] init];
...
- (MKTPLowPowerNoteSlider *)batterySlider2 {
    if (!_batterySlider2) {
        _batterySlider2 = [[MKTPLowPowerNoteSlider alloc] init];
...
- (MKTPLowPowerNoteSlider *)batterySlider3 {
    if (!_batterySlider3) {
        _batterySlider3 = [[MKTPLowPowerNoteSlider alloc] init];
