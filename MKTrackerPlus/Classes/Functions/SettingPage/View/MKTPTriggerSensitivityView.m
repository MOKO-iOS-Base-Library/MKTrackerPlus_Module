...
@interface MKTPTriggerSenSlider : UISlider
@end

@implementation MKTPTriggerSenSlider
...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        [self setMinimumTrackImage:[LOADICON(@"MKTrackerPlus", @"MKTPTriggerSenSlider", @"tp_sensitivityMinTrackIcon.png") resizableImageWithCapInsets:UIEdgeInsetsZero]
                          forState:UIControlStateNormal];
        [self setMaximumTrackImage:[LOADICON(@"MKTrackerPlus", @"MKTPTriggerSenSlider", @"tp_sensitivityMaxTrackIcon.png") resizableImageWithCapInsets:UIEdgeInsetsZero] forState:UIControlStateNormal];
    }
    return self;
}
...
@interface MKTPTriggerSensitivityView ()
...
@property (nonatomic, strong)MKTPTriggerSenSlider *slider;
...
@implementation MKTPTriggerSensitivityView
...
+ (void)showWithValue:(NSInteger)value
    ...
    MKTPTriggerSensitivityView *view = [[MKTPTriggerSensitivityView alloc] init];
    [view showViewWithValue:value completeBlock:block];
}
...
- (MKTPTriggerSenSlider *)slider {
    if (!_slider) {
        _slider = [[MKTPTriggerSenSlider alloc] init];
